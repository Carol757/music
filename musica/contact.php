                    ...
                    <div class="contact-content mb-100">
                        ...
                        <div class="contact-form-area">
                            ...
                            <form  method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="lname" placeholder="Your E-mail" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="psw" placeholder="Password" required>
                                </div>
                                
                                <button class="btn musica-btn mt-30" type="submit" onclick="myFunction()">send</button>
                                <p id="demo"></p>

<script>
function myFunction() {
  document.getElementById("demo").innerHTML = "THIS USER NAME IS ALREADY TAKEN";
}
</script>
                            </form>
                        </div>
